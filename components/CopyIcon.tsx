...
export const CopyIcon: React.FC<CopyIconProps> = ({ textToCopy }) => {
  ...
  return (
    <div className="cursor-pointer w-6" onClick={copyText}>
      {isCopied ? <span className='ml-3 text-green-500'> Copied!</span> : <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
